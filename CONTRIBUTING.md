# Contributing to AeroInsight

First off, thank you for considering contributing to AeroInsight! It's people like you that make AeroInsight such a great tool.
...
3. In the `backend/` directory, run `npm install`, set up your `.env`, and `npm run dev`.
